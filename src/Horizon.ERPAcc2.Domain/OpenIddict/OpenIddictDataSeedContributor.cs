...
namespace Horizon.ERPAcc2.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ERPAcc2") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ERPAcc2", DisplayName = "ERPAcc2 API", Resources = { "ERPAcc2" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["ERPAcc2_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["ERPAcc2_Web:RootUrl"]!.EnsureEndsWith('/');

            /* ERPAcc2_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["ERPAcc2_Web:ClientSecret"] ?? "1q2w3e*",
