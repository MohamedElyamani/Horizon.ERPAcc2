...
{
    [DbContext(typeof(ERPAcc2DbContext))]
    [Migration("20240128110315_created_fiscalPeriod")]
    partial class created_fiscalPeriod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Horizon.ERPAcc2.FiscalYearPeriods.FiscalYearPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("BeginingInventory")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("BeginingInventory");
                    ...
                    b.Property<decimal>("EndiningInventory")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("EndiningInventory");
                    ...
                    b.Property<int>("PeriodStatusId")
                        .HasColumnType("int")
                        .HasColumnName("PeriodStatusId");
                    ...
                    b.Property<decimal>("TotalDepit")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("TotalDepit");

                    b.HasKey("Id");

                    b.HasIndex("FiscalYearId");

                    b.ToTable("AppFiscalYearPeriod", (string)null);
                });

            modelBuilder.Entity("Horizon.ERPAcc2.FiscalYearStatuses.FiscalYearStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FiscalYearStatusTitle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("FiscalYearStatusTitle");
                    ...
                    b.ToTable("AppFiscalYearStatus", (string)null);
                });

            modelBuilder.Entity("Horizon.ERPAcc2.FiscalYears.FiscalYear", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("CalanderYear")
                        .HasColumnType("int")
                        .HasColumnName("CalanderYear");
                    ...
                    b.Property<int>("NoOfPeriods")
                        .HasColumnType("int")
                        .HasColumnName("NoOfPeriods");

                    b.Property<string>("PeriodInterval")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)")
                        .HasColumnName("PeriodInterval");
                    ...
                    b.ToTable("AppFiscalYear", (string)null);
                });
            ...
            modelBuilder.Entity("Horizon.ERPAcc2.FiscalYearPeriods.FiscalYearPeriod", b =>
                {
                    b.HasOne("Horizon.ERPAcc2.FiscalYears.FiscalYear", null)
            ...
            modelBuilder.Entity("Horizon.ERPAcc2.FiscalYears.FiscalYear", b =>
                {
                    b.HasOne("Horizon.ERPAcc2.FiscalYearStatuses.FiscalYearStatus", null)
                        .WithMany()
