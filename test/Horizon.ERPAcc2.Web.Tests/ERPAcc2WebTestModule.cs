...
[DependsOn(
    ...
    typeof(ERPAcc2WebModule),
    typeof(ERPAcc2ApplicationTestModule),
    typeof(ERPAcc2EntityFrameworkCoreTestModule)
)]
public class ERPAcc2WebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(ERPAcc2WebModule).Assembly));
        });
